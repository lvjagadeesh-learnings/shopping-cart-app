...
export function RecommendedProducts({
  ...
  return <section className="mt-10">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
        {products.map(product => <Link key={product.productId} to={`/products/id/${product.productId}`} className="rounded border border-gray-200 bg-white p-2 hover:shadow-md">
